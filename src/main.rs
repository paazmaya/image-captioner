...
use sesoko::caption::{
    resolve_caption_model_path, run_caption_folder, CandleVlmCaptionModel, CaptionOptions,
...
fn main() -> Result<()> {
    ...
    match cli.command {
        Some(Commands::Caption {
            ...
            let model = CandleVlmCaptionModel::load(model_dir, DEFAULT_CAPTION_PROMPT)?;
